...
def get_next_occurrences(rrule_string, count=5):
    """
...
def get_next_occurrences_date_only(rrule_string, count=5):
    """
    ...
    occurrences = get_next_occurrences(rrule_string, count)
